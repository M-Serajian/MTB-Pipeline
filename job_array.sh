...
ml python
ml perl
perl 31mer_analysis.pl -i resistant_genomes.csv -o . -b /blue/boucher/share/MTB/MTB_Database/BV_BRC_corrected -f fna -t /blue/boucher/share/MTB/MTB_Database/BV_BRC_MTB++_temp_files